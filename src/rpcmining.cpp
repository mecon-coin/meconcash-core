...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Meconcash is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Meconcash is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    result.push_back(Pair("info", result));
