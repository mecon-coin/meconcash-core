...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Meconcash " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"meconcash.io", "52.231.186.220"},
    {"meconcashseeder1.com", "52.231.186.173"},
    {"meconcashseeder2.com", "52.231.184.250"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Meconcash is probably already running."), addrBind.ToString().c_str());
        else
