...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MCH");
    case mBTC: return QString("mMCH");
    case uBTC: return QString::fromUtf8("μMCH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Meconcashs");
    case mBTC: return QString("Milli-Meconcashs (1 / 1,000)");
    case uBTC: return QString("Micro-Meconcashs (1 / 1,000,000)");
    default: return QString("???");
    }
}
