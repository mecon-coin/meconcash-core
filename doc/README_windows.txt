...
Setup
-----
After completing windows setup then run meconcash-qt.
Alternatively you can run windows command line (cmd) in meconcash program dir.
  cd daemon
  meconcashd
You would need to create a configuration file meconcash.conf in the default
wallet directory. Grant access to meconcashd/meconcash-qt in anti-virus and firewall
...
See the documentation/wiki at github:
  http://github.com/meconcash/meconcash
