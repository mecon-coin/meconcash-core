...
UNIX BUILD NOTES FOR MECONCASH
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/mecon-coin/meconcash-core.git
	cd meconcash-core
...
This will build Meconcash-Qt as well if the dependencies are met.
...
Note: Currently, there is no meconcash ebuild available in overlay
...
Take the following steps to build (no UPnP support):
	...
	strip src/meconcashd


Notes
-----
The release is built with GCC and then "strip meconcashd" to strip the debug
